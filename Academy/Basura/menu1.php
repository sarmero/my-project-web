    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/Academy/pages/profile.php">start</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/Academy/pages/books.php">Libros</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/Academy/pages/profile.php">perfil</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                       ...
                       foreach ($categries as $c) {
                           echo
                               '<li><a class="dropdown-item" href="/Academy/pages/collections.php?col=' .
                               $c['name']
                               . '">' .
                               $c['name']
                               . '</a></li>';
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/Academy/pages/partners_list.php">Socios</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item" href="/Academy/pages/author_list.php">Autores</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="/Academy/pages/book_list.php">Libros</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="#">Prestamos</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="/Academy/pages/partners_list.php">Socios</a>
                        </li>
                    </ul>
                </li>
            </ul>
